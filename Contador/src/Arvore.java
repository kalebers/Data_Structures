public class Arvore {
    ...
    public int tamanho_palavra(DATA palavra){
        return palavra.getInfo().length();
    }
    ...
    public void remove_elemento(DATA elemento){
        this.raiz = remove_elemento(this.raiz, elemento);
    }

    private No remove_elemento(No no, DATA elemento){
        ...
        String info_atual = no.getChave().getInfo();

        if (elemento.getInfo().equals(info_atual)){
        ...
        else if (tamanho_palavra(elemento) < tamanho_palavra(no.getChave())){
    ...
    public void insere_elemento(DATA elemento){
        this.raiz = insere_elemento(elemento, raiz);
    }

    private No insere_elemento(DATA elemento, No no){
        if (no == null){
    ...
    public boolean existe_elemento(DATA elemento){
        return existe_elemento(raiz, elemento);
    }

    private boolean existe_elemento(No no, DATA elemento){
        while (no != null){
            if (elemento.getInfo().equals(no.getChave().getInfo())){
                return true;
            }
            else if (tamanho_palavra(elemento) < tamanho_palavra(no.getChave())){
                no = no.getEsquerda();
    ...
    public No recupera_elemento(DATA elemento){
        return recupera_elemento(raiz, elemento);
    }

    private No recupera_elemento(No no, DATA elemento){
        while (no != null){
            if (elemento.getInfo().equals(no.getChave().getInfo())){
                return no;
            }
